...
<body>
	...
	<h2>후기 목록</h2>
	<a href="insertform.do" id="write">후기작성 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
