...
<div class="container">
	<c:if test="${dto.prevNum ne 0 }">
		<a href="detail.do?num=${dto.prevNum }&keyword=${encodedK}&condition=${condition}">
	...
	<c:if test="${dto.nextNum ne 0 }">
		<a href="detail.do?num=${dto.nextNum }&keyword=${encodedK}&condition=${condition}">
		다음글
	...
	<div class="container">
		...
		목록 보기
			...
			<c:if test="${id ne null }">
				<button id="likeBtn" class="btn btn-outline-primary"  style="float: right;">
...
<script>
	document.querySelector("#likeBtn").addEventListener("click" , function(){
		...
		.then(function(data){
			...
			document.querySelector("#likeBtn").classList.add("disabled");
		});
	});
