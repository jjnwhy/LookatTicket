...
<div class="container">
	...
	<div class="container">
		...
		목록 보기
			...
			<c:if test="${dto.writer eq id || id eq 'admin'}">
				...
				수정</a>		
				<a href="delete.do?num=${dto.num }" onclick="return confirm('리뷰를 삭제하시겠습니까?');">
	...
	<table class="table" id="myTable" align="center">
		...
		<tr>
			<td colspan="4" align="right">
				<c:if test="${id ne null && dto.writer ne id && id ne 'admin'}">
