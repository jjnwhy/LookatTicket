	...
	<div class="container">
		...
		<div class="container">
			...
			<c:if test="${id eq 'admin' }">
				...
				<a href="delete.do?num=${dto.num }" onclick="return confirm('공지사항을 삭제하시겠습니까?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
